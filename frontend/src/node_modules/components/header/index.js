...
import {toggleNavMenu, isUserLogin} from "actions";
...
const styles = theme => ({
    ...
    render() {
        ...
        const hasUserLogin = this.props.userSession.isLogin;
            ...
            <div className={classes.appFrame}>
                  ...
                  <AppBar
                    ...
                    <Toolbar >
                        ...
                        <FormControlLabel
                            control={
                                <Switch checked={hasUserLogin} onChange={this.handleChange} aria-label="LoginSwitch" />
                            }
                            label={hasUserLogin ? 'Logout' : 'Login'}
                        />
