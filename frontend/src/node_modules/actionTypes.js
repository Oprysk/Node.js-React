...
// ---------------------------------------------------------------------
// Actions for general app state
export const MAIN_NAV_START = ' MAIN_NAV_START'
export const MAIN_NAV_SUCCESS = ' MAIN_NAV_SUCCESS'
export const MAIN_NAV_FAILURE = ' MAIN_NAV_FAILURE'

// ---------------------------------------------------------------------
// Main actions for user and app state
export const USER_SESSION_LOGIN_START = 'USER_SESSION_LOGIN_START'
export const USER_SESSION_LOGIN_SUCCESS = 'USER_SESSION_LOGIN_SUCCESS'
export const USER_SESSION_LOGIN_FAILURE = 'USER_SESSION_LOGIN_FAILURE'